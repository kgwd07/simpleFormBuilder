...
//     //       <h1 className="text-gray-600 text-2xl font-bold">Edit Form</h1>
...
//     //           Save as Draft
//     //         </Button>
//     //         <Button onClick={() => handleUpdateForm(FormStatus.Published)}>
//     //           Publish
//     //         </Button>
//     //         {/* <Button
//     //           variant="outline"
//     //           onClick={() => router.push(`/forms/preview/${id}`)}
//     //         >
//     //           Preview
//     //         </Button> */}
//     //       </div>
...
//     //               placeholder="Add a description to provide more context about your form"
//     //             /> */}
//     //             <Input
//     //               id="form-description"
//     //               label="Description (optional)"
...
//     //                       </div>
//     //                     )}
//     //                     <div className="h-10 bg-white rounded border border-gray-300 mt-1"></div>
//     //                   </div>
//     //                 ))}
//     //               </div>
//     //             )}
...
//     const handleSaveForm = (status: FormStatus) => {
...
//       useEffect(() => {
//         setSelectedQuestion(currentForm?.questions?.at(-1) || null)
...
//           <div className="flex justify-between items-center mb-6">
//             {/* <h1 className="text-gray-600 text-2xl font-bold">Create Form</h1> */}
...
//                         <div 
//                           key={question.id} 
//                           className={`p-3 text-gray-600 rounded-lg cursor-pointer transition-colors ${
